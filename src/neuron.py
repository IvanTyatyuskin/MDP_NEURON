...
# Путь к видео
video_path = "C:/Users/Иван/Downloads/input_video.mp4" #подумать!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
output_path = 'C:/Users/Иван/Downloads/test_video_sec.mp4' #удалить
...
while cap.isOpened():
    ...
    if success:
        ...
        results = model.track(frame, classes=1, persist=True) #class 0 - человек целиком, class 1 - только голова
